...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
	...
	private void calculate() {
		...
		if(firstCard == secondCard){
			...
			iv_11.setImageResource(R.drawable.oo);
			iv_12.setImageResource(R.drawable.oo);
			iv_13.setImageResource(R.drawable.oo);
			iv_14.setImageResource(R.drawable.oo);
			iv_21.setImageResource(R.drawable.oo);
			iv_22.setImageResource(R.drawable.oo);
			iv_23.setImageResource(R.drawable.oo);
			iv_24.setImageResource(R.drawable.oo);
			iv_31.setImageResource(R.drawable.oo);
			iv_32.setImageResource(R.drawable.oo);
			iv_33.setImageResource(R.drawable.oo);
			iv_34.setImageResource(R.drawable.oo);
	...
	private void frontOfCardsResources() {
		image101 = R.drawable.b;
		image102 = R.drawable.y;
		image103 = R.drawable.m;
		image104 = R.drawable.o;
		image105 = R.drawable.t;
		image106 = R.drawable.q;
		image201 = R.drawable.b;
		image202 = R.drawable.y;
		image203 = R.drawable.m;
		image204 = R.drawable.o;
		image205 = R.drawable.t;
		image206 = R.drawable.q;
	}
}
